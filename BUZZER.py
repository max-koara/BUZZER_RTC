...
buzzer_spec = ["implementation_id", "BUZZER", 
		 "type_name",         "BUZZER", 
...
def BUZZERInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=buzzer_spec)
...
def MyModuleInit(manager):
    ...
    # Create a component
    comp = manager.createComponent("BUZZER")
